 ...
 *</p>
 */
public class ThreadWOBarrier extends java.lang.Thread implements Runnable {
     ...
     */
    public ThreadWOBarrier(int rowsAndColumns, int rowStartPoint, int rowEndPoint, int columnStartPoint, int columnEndPoint, double[][] grid, double[] averagePerThread, double[] errorPerThread, int threadID, Thread[] threads) {
