package FourThreadWithoutBarrier;

/**
 * This is the main runner for the 4-thread without barrier program.
 *
 * <p>
 *     This is the class that will be calling all of the methods in the GridFill and ThreadWOBarrier class.
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        // Formatting
        System.out.println("4-Threaded Solution Without Barrier:\n");
        ...
        for(int i = 0; i < numThreads  ; i++ ) {
            ...
            if ( i == 1 ) {
                ...
                rowEndPoint = (findMiddle / 2);
                columnEndPoint = (findMiddle / 2 + 1) + ((findMiddle / 2) - 1);
            }
            ...
            averages[i] = new ThreadWOBarrier(rowsAndColumns, rowStartPoint , rowEndPoint , columnStartPoint , columnEndPoint , grid, avg, error, i, averages);
        }
        ...
        // Formatting for the final tread results
        for(int i = 0; i < numThreads; i++) {
            System.out.println("Thread " + (i+1) + " Average: " + avg[i]);
            System.out.println("Thread " + (i+1) + " Error: " + error[i]);
            System.out.println();
        ...
        // sum up threadError to get totalError
        double errorTotal = 0;
        for (int i = 0; i < numThreads; i++) {
            errorTotal += error[i];
        }
